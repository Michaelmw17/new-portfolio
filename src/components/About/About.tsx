...
export default function About() {
  return (
    <section
      className="relative -mt-24 z-20 flex flex-col items-center justify-center"
      id="about"
    >
      {/* Wave SVG at the top */}
      <div className="bg-white rounded-xl shadow-lg max-w-3xl w-full mx-auto mt-10">
        <div className="w-full overflow-hidden leading-none h-20">
          ...
          >
            ...
            <g className="parallax">
              <use xlinkHref="#gentle-wave" x="48" y="0" fill="#05fdfd" />
              <use
        ...
        <div className="px-8 py-4 md:px-14 md:py-10">
          <h2 className="font-bold text-3xl md:text-4xl text-center mb-6">
            About
          </h2>
          ...
          <p className="text-gray-700 text-lg text-center mb-6">
            Outside of work, I enjoy surfing, playing golf, watching UFC, and
